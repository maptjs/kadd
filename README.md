...
3. **لم يُختبَر بعد على جهاز حقيقي** — كل شيء هنا كُتب ودُقّق منطقيًا لكن ما
   ...
   حقيقي قد يكشف تفاصيل صغيرة تحتاج تعديلًا (عتبات زاوية المرفق، سلوك
   `sensorOrientation` على أجهزة معيّنة، وكذلك التلميعات الجديدة — الخلفية
   المرسومة والاهتزاز وشاشات الاحتفال — ما جُرِّبت بصريًا على جهاز حقيقي بعد).
